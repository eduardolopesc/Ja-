...
//
//
//class PlayingViewController: UIViewController, SPTAudioStreamingPlaybackDelegate, SPTAudioStreamingDelegate {
//
//    var item: Item?
...
//        //            }
//        //        }
//        //        NotificationCenter.default.addObserver(self, selector: #selector(PlayingViewController.updateAfterFirstLogin), name: Notification.Name(rawValue: "loginSuccessfull"), object: nil)
//        //
//
...
//                            self.player?.setIsPlaying(true, callback: nil)
//
//                        }else {self.statusLabel.text = "stop"
